...
const Hero = () => {
  ...
  const [text] = useTypewriter({
    words: portfolioData?.hero?.titles || ['Fullstack Developer', 'Cybersecurity Researcher', 'Tech Innovator'],
    loop: true,
    delay: 70,
    deleteSpeed: 50,
  });
  ...
  if (loading) {
    return (
      <section id="home" className="py-20 relative min-h-screen flex items-center justify-center">
      ...
      <div className="container mx-auto px-6 z-10">
        ...
        >
          ...
          <motion.h1 className="text-5xl md:text-7xl font-bold mb-4">
            <span className="gradient-text">{portfolioData?.hero?.name || 'Geta Tenaw'}</span>
          </motion.h1>
          ...
          <motion.p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
            {portfolioData?.hero?.description || 'Passionate about building secure, scalable web applications and exploring the latest in cybersecurity and AI.'}
          </motion.p>
